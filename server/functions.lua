...
ESX.SavePlayers = function(cb)
	...
	if #xPlayers > 0 then
		...
		local selectListWithNames = "SELECT '%s' AS identifier, '%s' AS new_accounts, '%s' AS new_job, '%s' AS new_job2, %s AS new_job_grade, %s AS new_job2_grade, '%s' AS new_group, '%s' AS new_loadout, '%s' AS new_position, '%s' AS new_inventory "
