...
AddEventHandler('esx:playerLoaded', function(playerData)
	...
	ESX.ShowNotification("~g~Vous avez été replacé à votre dernière position.")
	ESX.ShowNotification("~b~N'oubliez pas d'aller voter pour le serveur.")
	--ESX.ShowNotification("~b~TeamSpeak~n~~s~N'oubliez pas de vous connecter au TeamSpeak pour le chat vocal (aldalys.fr).")
	--ESX.ShowNotification("~b~TeamSpeak~n~~s~N'oubliez pas d'activer le plugin salty chat.")
end)
...
AddEventHandler('esx:createPickup', function(pickupId, label, coords, type, name, components, tintIndex)
	...
	if type == 'item_weapon' then
		...
		ESX.Game.SpawnLocalObject('prop_cardbordbox_05a', coords, setObjectProperties)
	end
end)
